...
public class HiveSpitter : Enemy
{
    ...
    public override IEnumerator StartMyActivationCoroutine()
    {
        ...
        // Move if outside of spit range
        else if (IsTargetInRange(myCurrentTarget, acidSpit.abilityRange) == false && IsAbleToMove() && HasEnoughAP(currentAP, move.abilityAPCost))
        {
